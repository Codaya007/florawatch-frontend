...
export const ELECTRIC_BLUE="#0042A6";
export const DEEP_BLUE="#07173F";
export const ROCKET_RED="#E43700";
export const MARTIAN_RED="#8E1100";
export const NEON_YELLOW="#EAFE07";
