...
export default function HomePage() {
  ...
  const [dateRange, setDateRange] = useState<DateRange>({ start: dayjs().format('YYYY-MM-DD'), end: null }); 
  ...
  return (
    <div className="flex flex-1 overflow-hidden">
      ...
      {/* <div style={{ height: '80vh', width: '100%' }}>
        ...
        <div className={`h-48 p-4 rounded-xl primary-bg border border-deep-blue`}>
      ...
      <div className={`w-96 secondary-bg p-6 overflow-y-auto scrollbar-hidden h-full`}>
        <Sidebar 
          dateRange={dateRange}
