...
const InfoCard: React.FC<InfoCardProps> = ({ title, children }) => {
  return (
    ...
    <div className={`primary-bg p-3 rounded-xl shadow-lg border border-deep-blue mb-6`}>
      
      {/* Estilos del Título: color de acento y separador */}
      <h3 className={`text-xl font-bold mb-3 text-[#d3d8e0] border-b border-white pb-2`}>
        {title}
      </h3>
